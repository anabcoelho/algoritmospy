...
class Cartao:
    ...
    def insert_cartao(self, id_cartao, id_user, creditos, tipo, data_emissao):
        import conectar
    ...
    def novo_cartao (self):
        ...
        Cartao(id_cartao, id_user, creditos, tipo, data_emissao).insert_cartao(id_cartao, id_user, creditos, tipo, data_emissao)
